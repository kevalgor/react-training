...
const TailwindUI = () => {
  return (
    <>
      <h3 className="text-2xl">Tailwind pagination</h3>
        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          ...
          <div>
            ...
            >
              ...
              <span className="relative hidden items-center border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 focus:z-20 md:inline-flex">
                5
              </span>
              <span className="relative inline-flex items-center border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 focus:z-20">
                6
